...
export default function AnnouncementSpotlight() {
  ...
  return (
    <aside className="card relative w-full overflow-hidden rounded-3xl bg-gradient-to-br from-purple-700/90 via-fuchsia-600/80 to-indigo-700/90 text-white shadow-[0_0_35px_rgba(168,85,247,0.35)] xl:sticky xl:top-28">
