      ...
      <nav className="w-full border-b border-white/10 bg-[var(--card)]/90 backdrop-blur-xl">
        <div className="max-w-6xl mx-auto w-full px-4 py-4 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            <div className="flex-1 overflow-x-auto pb-1 order-1">
            ...
            <div className="order-2 flex justify-end md:items-center">
              <button
                onClick={logout}
                className="btn px-6 py-2.5 text-base font-semibold tracking-wide sm:w-auto sm:min-w-[10rem]"
              >
                Wyloguj
              </button>
            </div>
