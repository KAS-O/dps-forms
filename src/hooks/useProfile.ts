...
import { Role, normalizeRole, DEFAULT_ROLE, hasBoardAccess } from "@/lib/roles";
...
export const can = {
  ...
  editRecords: (role: Role | null) => hasBoardAccess(role),
  accessAdminPanel: (role: Role | null) => hasBoardAccess(role),
};
