...
import { ROLE_LABELS, ROLE_VALUES, hasBoardAccess, DEFAULT_ROLE } from "@/lib/roles";
...
export default function Admin() {
  ...
  const saveAccount = async () => {
    ...
    const roleValue = (editorState.account.role || DEFAULT_ROLE) as Role;
            ...
            {section === "logs" && (
              <div className="grid gap-5">
                <div className="card bg-gradient-to-br from-amber-900/85 via-amber-800/85 to-stone-900/80 text-white p-6 shadow-xl">
                  ...
                  <p className="text-sm text-white/70">
                    Historia logowań, zmian danych i wszystkich operacji w panelu. Dostępna wyłącznie dla kadr w randze
                    <b> Staff Commander</b> i wyższej.
                  </p>
