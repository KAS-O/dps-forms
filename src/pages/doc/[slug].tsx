            ...
            <div className="flex flex-col gap-6">
              {pages.map((pageFields, pageIndex) => (
                <div
                  ...
                  className={
                    isWniosekTemplate
                      ? "bg-white text-black mx-auto w-[900px] max-w-full aspect-[210/297] p-4 border border-beige-300 shadow-sm doc-page"
                      : "bg-white text-black mx-auto w-[900px] max-w-full aspect-[210/297] p-8 border border-beige-300 shadow-sm doc-page"
                  }
                >
                  <div
                    className={
                  ...
                  <hr className={isWniosekTemplate ? "border-beige-300 mb-3" : "border-beige-300 mb-4"} />
                  ...
                  <div
                    className={
                      isWniosekTemplate ? "mb-3 text-[11px] leading-tight" : "mb-4 text-[12px]"
                    }
                  >
                  ...
                  {isWniosekTemplate ? (
                    <div
                      className="space-y-2 text-[11px] leading-[1.3] doc-fields"
